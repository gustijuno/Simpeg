                    ...
                    <div class="quick-actions-scroll scrollbar-outer">
                        <div class="quick-actions-items">
                            <div class="row m-0">
                                ...
                                <a class="col-6 col-md-4 p-0" href="{{route('tipePegawai.create')}}">
                                    <div class="quick-actions-item">
                            ...
                            <div class="row m-0">
                                <a class="col-12 col-md-12 p-0" href="{{route('NIP.create')}}">
                                    <div class="quick-actions-item">
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                        <li>
                            <div class="user-box">
                                <div class="avatar-lg">
                                    @if(Auth::user()->foto == 'null')
                                    <img src="{{ asset('img/avatar.png')}}" alt="image profile" class="avatar-img rounded">
                                    @else
                                    <img src="{{ Storage::url(Auth::user()->foto)}}" alt="image profile" class="avatar-img rounded">
                                    @endif
                                </div>
                                <div class="u-text">
