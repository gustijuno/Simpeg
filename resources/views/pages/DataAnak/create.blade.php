...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{route('Anak.buat', $keluarga->id)}}">Tambah Data Anak</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Tambah Data Anak</div>
                </div>
                <form method="POST" action="{{ route('Anak.store') }}" id="myForm">
                    @csrf
                    <div class="card-body">
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-">
                                ...
                                <div class="form-group">
                                    ...
                                    <select @if($errors->has('jenis_kelamin')) autofocus @endif class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin">
                                ...
                                <div class="form-group">
                                    ...
                                    <select @if($errors->has('pendidikan')) autofocus @endif class="form-control @error('pendidikan') is-invalid @enderror" name="pendidikan" id="pendidikan">
                                        <option value="">--- Pilih ---</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input @if($errors->has('kewarganegaraan')) autofocus @endif value="{{old('kewarganegaraan')}}" type="text" class="form-control @error('kewarganegaraan') is-invalid @enderror" name="kewarganegaraan" id="kewarganegaraan">
                            ...
                            <div class="col-md-6 col-lg-">
                                ...
                                <div class="form-group">
                                    ...
                                    <input @if($errors->has('jenis_pekerjaan')) autofocus @endif class="form-control @error('jenis_pekerjaan') is-invalid @enderror" value="{{old('jenis_pekerjaan')}}" name="jenis_pekerjaan" id="jenis_pekerjaan" list="jenis_pekerjaan_list">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-">
                                <div class="form-group">
                                    ...
                                    <input @if($errors->has('nama_ayah')) autofocus @endif type="text" name="nama_ayah" value="{{$keluarga->pegawai->nama}}" class="form-control @error('nama_ayah') is-invalid @enderror" id="nama_ayah">
                                    @error('nama_ayah')
                                    <span class="invalid-feedback" role="alert">
                                        <strong class="text-capitalize">{{$message}}</strong>
                                    </span>
                            ...
                            <div class="col-md-6 col-lg-">
                                <div class="form-group">
                                    ...
                                    <input @if($errors->has('nama_ibu')) autofocus @endif type="text" name="nama_ibu" value="{{$keluarga->pasangan->nama_lengkap}}" class="form-control @error('nama_ibu') is-invalid @enderror" id="nama_ibu">
                                    @error('nama_ibu')
                                    <span class="invalid-feedback" role="alert">
                                        <strong class="text-capitalize">{{$message}}</strong>
                                    </span>
                    ...
                    <div class="card-action">
                        <a class="btn btn-danger" href="{{route('Anak.list',$keluarga->id)}}">Kembali</a>
